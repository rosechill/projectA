...
import ViewUserModal from "../ViewHistoryPesananModal";
      ...
      switch (columnKey) {
        ...
        case "actions":
          return (
            <Tooltip
              content="Details"
              className="p-1.5 border rounded-lg bg-white border-blue-600 w-full"
            >
              <p
                onClick={() => openUserDetailsModal(User)}
                className="text-base text-blue-600 cursor-pointer active:opacity-50 w-full"
              >
                Lihat Pesanan <IconFilledEye />
              </p>
            </Tooltip>
          );
        default:
  ...
  return (
    <div className="p-7">
      <div className="p-4 border border-gray-100 shadow-lg rounded-lg">
        <h2 className="text-2xl font-semibold pb-4">Master History Pesanan</h2>
        <Table
          isCompact
          removeWrapper
