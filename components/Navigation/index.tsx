      ...
      <div className="flex w-full justify-between items-center max-desktop:hidden h-80px px-16">
        ...
        <div className="flex gap-4 ">
          <Link href={"/login"} className="">
            <Button className="bg-white border-2 border-[#B02525] w-[120px] text-[#1E5494]"> Masuk</Button>
          </Link>
          <Link href={"/daftar"} className="">
            <Button className="bg-white border-2 border-[#1E5494] w-[120px] text-[#B02525]"> Daftar</Button>
          </Link>
        </div>
      </div>
    </Navbar>
